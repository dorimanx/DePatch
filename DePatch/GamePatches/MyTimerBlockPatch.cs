...
namespace DePatch
{
    ...
    public static class MyTimerBlockPatch
    {
        ...
        internal static readonly MethodInfo UpdatePatch = typeof(MyTimerBlockPatch).GetMethod("PatchMethod", BindingFlags.Static | BindingFlags.Public) ?? throw new Exception("Failed to find patch method");
        ...
        internal static readonly MethodInfo TrigNowPatch = typeof(MyTimerBlockPatch).GetMethod("TrigMethod", BindingFlags.Static | BindingFlags.Public) ?? throw new Exception("Failed to find patch method");
